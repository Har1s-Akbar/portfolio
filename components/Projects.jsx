...
function Projects({data}) {
  return (
    <section className='lg:grid lg:grid-cols-2  my-10'>
        ...
        {data?.map((item, index)=> 
        <Card key={index} cover={<img src={urlFor(item.image)} alt={item.title}/>} style={{width: '75%', height: '90%', margin: 'auto', marginTop: '2rem'}} hoverable>
